    ...
    public class EnemiesLevelFour
    {
        public static List<EnemySection> GetEnemies()
        {
            return new List<EnemySection>()
            {
                ...
                new(80, false, new DSpread(100, EEnemyProjectileType.Light, 2), new DSpread(1300, EEnemyProjectileType.Light, 2)),

                new(80, false, new DSpread(200, EEnemyProjectileType.Light, 2), new DSpread(1200, EEnemyProjectileType.Light, 2), new DCommon(100, 2), 
                                                                                                                                    new DCommon(1300, 2)),
            
                new(80, false, new DSpread(300, EEnemyProjectileType.Light, 2), new DSpread(1100, EEnemyProjectileType.Light, 2), new DCommon(100, 2),
                                                                                                                                    new DCommon(200, 2), 
                                                                                                                                    new DCommon(1200, 2), 
                                                                                                                                    new DCommon(1300, 2)),
                
                new(80, false, new DSpread(400, EEnemyProjectileType.Light, 2), new DSpread(1000, EEnemyProjectileType.Light, 2), new DCommon(100, 2),
                                                                                                                                    new DCommon(200, 2), 
                                                                                                                                    new DCommon(300, 2), 
                                                                                                                                    new DCommon(1100, 2), 
                                                                                                                                    new DCommon(1200, 2), 
                ...
                new(80, false, new DSpread(500, EEnemyProjectileType.Light, 2), new DSpread(900, EEnemyProjectileType.Light, 2), new DCommon(100, 2),
                                                                                                                                    new DCommon(200, 2), 
                                                                                                                                    new DCommon(300, 2), 
                                                                                                                                    new DCommon(400, 2), 
                                                                                                                                    new DCommon(1000, 2), 
                ...
                new(80, false, new DSpread(600, EEnemyProjectileType.Light, 2), new DSpread(800, EEnemyProjectileType.Light, 2), new DCommon(100, 2),
                                                                                                                                    new DCommon(200, 2), 
                                                                                                                                    new DCommon(300, 2), 
                                                                                                                                    new DCommon(400, 2), 
                                                                                                                                    new DCommon(500, 2), 
                ...
                new(80, false, new DSpread(700, EEnemyProjectileType.Light, 2),new DCommon(100, 2),
                                                                                new DCommon(200, 2), 
                                                                                new DCommon(300, 2), 
                                                                                new DCommon(400, 2), 
                                                                                new DCommon(500, 2), 
                ...
                new(80, false, new DCommon(100, 2)
                             , new DCommon(200, 2)
                             , new DCommon(300, 2)
                             , new DCommon(400, 2)
                             , new DCommon(500, 2)
                ...
                new(80, true, new DSpread(100, EEnemyProjectileType.Light, 2), new DSpread(1300, EEnemyProjectileType.Light, 2)),
