    ...
    public static class EnemiesLevelOne
    {
        public static List<EnemySection> GetEnemies()
        {
            return new List<EnemySection>()
            {
                ...
                new(20, false, new DCurver(700)),
                new(20, false, new DCurver(600), new DCurver(800)),
                new(20, false, new DCurver(500), new DCurver(900)),
                new(20, false, new DCurver(400), new DCurver(1000), new DSpread(100, EEnemyProjectileType.Normal)),
                new(20, false, new DCurver(300), new DCurver(1200)),
                new(20, false, new DCurver(200), new DCurver(1300)),
