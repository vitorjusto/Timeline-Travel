...
namespace Shooter.Source.Models.Enemies
{
    ...
    {
        private readonly QuickTimer _time = new(80);
        ...
        {
            _sprite.Modulate = Color.Color8(255, 255, 255, (byte)(_time.Time * 3));
            _lightSprite.Modulate = Color.Color8(255, 255, 255, (byte)(_time.Time * 3));
